...
export const expandAreaTimeline            = (columnId, area, { maxId } = {}) => expandTimeline(`area:${columnId}:${area}`, `/api/v1/timelines/area/${area}`, { max_id: maxId });
...
export const fillAreaTimelineGaps      = (columnId, area) => fillTimelineGaps(`area:${columnId}:${area}`, `/api/v1/timelines/area/${area}`, {});
