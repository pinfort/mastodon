...
export const links = [
  ...
  <NavLink className='tabs-bar__link' to='/areas' data-preview-title-id='column.area' data-preview-icon='map-marker' ><Icon id='map-marker' fixedWidth /><FormattedMessage id='tabs_bar.area_timeline' defaultMessage='Area' /></NavLink>,
