  ...
  render () {
    return (
      <div className='tabs-bar'>
        ...
        <NavLink className='tabs-bar__link secondary' activeClassName='active' exact to='/timelines/area'><i className='fa fa-fw fa-commenting' /><FormattedMessage id='tabs_bar.area_timeline' defaultMessage='Area' /></NavLink>
